            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading text-center">
                        {{ trans('User.create.add_user') }}
                    </div>
                    <div class="panel-body">
                        @if(isset($error))
                            <div class="alert alert-danger text-center">
                                <strong>{{ trans('User.create.error') }}:</strong> {{ $error }}
                            </div>
                        @else
                            <br><br>
                        @endif
                            ...
                            <form class="form-horizontal" action="{{ route('adduser') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="firstname">
                                        <b>{{ trans('User.create.firstname') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <small class="col-sm-8 col-sm-offset-2 text-muted">
                                        {{ trans('User.create.password_minimum_length') }}
                                        <span class="glyphicon glyphicon-info-sign"></span>
                                    </small>
                                    <br>
                                    <label class="control-label col-sm-2" for="password">
                                        <b>{{ trans('User.create.password') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="password_again">
                                        <b>{{ trans('User.create.password_again') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <br><br>
                                        <button class="btn btn-default" title="{{ trans('User.create.button-add_user') }}"
                                               type="submit">
                                            {{ trans('User.create.button-add_user') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
