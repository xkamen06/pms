            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading text-center">
                        {{ trans('pms::User.edit.header') }}
                    </div>
                    <div class="panel-body">
                        @if(isset($error))
                            <div class="alert alert-danger text-center">
                                <strong>{{ trans('pms::User.edit.error') }}:</strong> {{ $error }}
                            </div>
                        @else
                            <br><br>
                        @endif
                            ...
                            <form class="form-horizontal" action="{{ route('updateuser', ['userId' => $user->getUserId()]) }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="firstname">
                                        <b>{{ trans('pms::User.edit.firstname') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="surname">
                                        <b>{{ trans('pms::User.edit.surname') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button class="btn btn-default" title="{{ trans('pms::User.edit.button-edit') }}"
                                                type="submit">
                                            {{ trans('pms::User.edit.button-edit') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
