                            ...
                            <form class="form-horizontal" action="{{ route('updateteam', ['teamId' => $team->getTeamId()]) }}" method="post">
                                ...
                                <div class="form-group">
                                    <small class="col-sm-8 col-sm-offset-2 text-muted">
                                        {{ trans('pms::Team.edit.unique_shortcut') }}
                                        <span class="glyphicon glyphicon-info-sign"></span>
                                    </small>
                                    <br>
                                    <label class="control-label col-sm-2" for="shortcut">
                                        <b>{{ trans('pms::Team.edit.shortcut') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="fullname">
                                        <b>{{ trans('pms::Team.edit.fullname') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="description">
                                        <b>{{ trans('pms::Team.edit.description') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="permissions">
                                        <b>{{ trans('pms::Team.edit.permissions') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                        <select class="form-control" name="permissions" id="permissions">
                                            @if($team->getPermissions() === 'all')
                                                <option value="all" selected>{{ trans('pms::Team.edit.all') }}</option>
                                                <option value="members">{{ trans('pms::Team.edit.members') }}</option>
                                            @else
                                                <option value="all">{{ trans('pms::Team.edit.all') }}</option>
                                                <option value="members" selected>{{ trans('pms::Team.edit.members') }}</option>
                                            @endif
                                        </select>
                                    </div>
                                    <br><br><br>
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-default" title="{{ trans('pms::Team.edit.button-edit_team') }}">
                                            {{ trans('pms::Team.edit.button-edit_team') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
