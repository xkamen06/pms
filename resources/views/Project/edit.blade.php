            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading text-center">
                        {{ trans('pms::Project.edit.header') }}
                    </div>
                    <div class="panel-body">
                        <div class="col-sm-10 col-sm-offset-1">
                            @if(isset($error))
                                <div class="alert alert-danger text-center">
                                    <strong>{{ trans('pms::Project.edit.error') }}:</strong> {{ $error }}
                                </div>
                            @else
                                <br><br>
                            @endif
                            <form class="form-horizontal" action="{{ route('updateproject', ['projectId' => $project->getprojectId()]) }}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="shortcut">
                                        <b>{{ trans('pms::Project.edit.shortcut') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="fullname">
                                        <b>{{ trans('pms::Project.edit.fullname') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="description">
                                        <b>{{ trans('pms::Project.edit.content') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="permissions">
                                        <b>{{ trans('pms::Project.edit.permissions') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                        <select class="form-control" name="permissions" id="permissions">
                                            @if($project->getPermissions() === 'all')
                                                <option value="all" selected>{{ trans('pms::Project.edit.all') }}</option>
                                                <option value="members">{{ trans('pms::Project.edit.members') }}</option>
                                            @else
                                                <option value="all">{{ trans('pms::Project.edit.all') }}</option>
                                                <option value="members" selected>{{ trans('pms::Project.edit.members') }}</option>
                                            @endif
                                        </select>
                                    </div>
                                    <br><br><br>
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button class="btn btn-default" type="submit" title="{{ trans('pms::Project.edit.button-edit_project') }}">
                                            {{ trans('pms::Project.edit.button-edit_project') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
