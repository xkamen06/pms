                            ...
                            <form action="{{ route('updatearticle', ['articleId' => $article->getArticleId()]) }}" method="post"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="title">
                                        <b>{{ trans('pms::Article.edit.title') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="subtitle">
                                        <b>{{ trans('pms::Article.edit.subtitle') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <label class="control-label col-sm-2" for="type">
                                        <b>{{ trans('pms::Article.edit.type') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                        <select class="form-control" name="type" id="type" required>
                                            @if($article->getType() === 'info')
                                                <option value="info" selected>{{ trans('pms::Article.edit.info') }}</option>
                                                <option value="requirement">{{ trans('pms::Article.edit.requirement') }}</option>
                                                <option value="attention">{{ trans('pms::Article.edit.attention') }}</option>
                                            @elseif($article->getType() === 'requirement')
                                                <option value="info">{{ trans('pms::Article.edit.info') }}</option>
                                                <option value="requirement" selected>{{ trans('pms::Article.edit.requirement') }}</option>
                                                <option value="attention">{{ trans('pms::Article.edit.attention') }}</option>
                                            @elseif($article->getType() === 'attention')
                                                <option value="info">{{ trans('pms::Article.edit.info') }}</option>
                                                <option value="requirement">{{ trans('pms::Article.edit.requirement') }}</option>
                                                <option value="attention" selected>{{ trans('pms::Article.edit.attention') }}</option>
                                            @endif
                                        </select>
                                    </div>
                                    <br><br><br>
                                    ...
                                    <label class="control-label col-sm-2" for="content">
                                        <b>{{ trans('pms::Article.edit.content') }}</b>
                                    </label>
                                    <div class="col-sm-8">
                                    ...
                                    <small class="col-sm-8 col-sm-offset-2 text-muted">
                                        {{ trans('pms::Article.edit.select_image') }}
                                    ...
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button class="btn btn-default" type="submit" title="{{ trans('pms::Article.edit.edit') }}">
                                            {{ trans('pms::Article.edit.edit') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
