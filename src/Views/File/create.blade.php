                            ...
                            @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="control-label col-sm-2" for="type">
                                            <b>{{ trans('File.create.type') }}</b>
                                        </label>
                                        <div class="col-sm-8">
                                            <select class="form-control" name="type" id="type">
                                                <option value="task">{{ trans('File.create.task') }}</option>
                                                <option value="submit">{{ trans('File.create.submit') }}</option>
                                            </select>
                                        </div>
                                        <br><br><br>

                                        <label class="control-label col-sm-2" for="description">
                                            <b>{{ trans('File.create.description') }}</b>
                                        </label>
                                        <div class="col-sm-8">
                                        ...
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button class="btn btn-default" type="submit" title="{{ trans('File.create.button-add_file') }}">
                                                {{ trans('File.create.button-add_file') }}
                                            </button>
                                        </div>
                                    </div>
                                </form>
